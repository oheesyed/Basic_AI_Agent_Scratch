...
def basic_calculator(input_str):
    ...
    Returns:
    str: The formatted result of the operations.
    ...
    try:
        ...
        # Extract the numbers and operation from the dictionary
        num1 = input_dict['num1']
        num2 = input_dict['num2']
        operation = input_dict['operation']
    except (json.JSONDecodeError, KeyError) as e:
        return str(e), "Invalid input format. Please provide a valid JSON string with 'num1', 'num2', and 'operation' keys."
